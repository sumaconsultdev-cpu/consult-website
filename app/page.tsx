...
const SERVICES_HOME = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1638864616266-c390568f9092?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxudW1iZXJzJTIwc2FjcmVkJTIwZ2VvbWV0cnklMjBtaW5pbWFsfGVufDF8fHx8MTc3ODU4MjA5M3ww&ixlib=rb-4.1.0&q=80&w=1080',
    alt: 'Numerology',
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1759310707368-e36f321b3187?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsaXN0JTIwYXJjaGl0ZWN0dXJlJTIwaW50ZXJpb3IlMjB6ZW58ZW58MXx8fHwxNzc4NTgyMDkzfDA&ixlib=rb-4.1.0&q=80&w=1080',
    alt: 'Vaastu',
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1664464683199-1b117efc42f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWElMjBoYW5kcyUyMHRhbGtpbmclMjB0aGVyYXB5JTIwbWluaW1hbHxlbnwxfHx8fDE3Nzg1ODIwOTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    alt: 'Guidance',
  },
]
...
export default function HomePage() {
  return (
    <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="relative w-4/5 sm:w-4/5 md:w-3/4 lg:w-4/5">
                ...
                <div className="relative z-10 rounded-3xl overflow-hidden aspect-[4/5] shadow-lg">
                  <Image
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <div className="space-y-4 text-lg text-[#5A5A5A] font-light leading-relaxed">
                <p>I guide individuals and families to bring harmony into their lives using Numerology and Vaastu principles.</p>
                <p>
                  With a deep interest in energy alignment, along with my journey in Reiki and Yoga, I help you make practical changes that
                  create real transformation. My approach is personal, deeply rooted in traditional wisdom, and tailored to your unique modern lifestyle.
                </p>
                <p>Let&apos;s work together to unlock the potential within you and your surroundings.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Services */}
      <section id="services" className="py-24 bg-[#FAF9F6] scroll-mt-24">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {SERVICES_HOME.map((s) => (
              <Card key={s.title} className="hover:-translate-y-2 transition-transform duration-300 border-none shadow-md overflow-hidden group flex flex-col h-full">
                ...
                <CardContent className="pt-0 pb-8 mt-auto">
                  <Link href="/book" className="text-[#C5A880] font-medium flex items-center hover:text-[#B39670] transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center p-6 rounded-3xl bg-[#FAF9F6] border border-[#E6E2F3]/50">
                ...
                <h4 className="text-lg font-medium text-[#2D2D2D] mb-2">{f.title}</h4>
                <p className="text-[#7A7A7A]">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {[1, 2, 3].map((item) => (
              <Card key={item} className="border-none shadow-md bg-white p-8 rounded-3xl relative">
                ...
                <p className="text-[#5A5A5A] italic mb-8 relative z-10">
                  &ldquo;Suma&apos;s guidance completely transformed the energy in our home. The practical Vaastu remedies were easy to implement and brought immediate peace to our family.&rdquo;
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#FAF9F6] rounded-full flex items-center justify-center text-[#8E7CC3] font-serif text-xl">S</div>
                  <div>
            ...
            {[
              ...
              <div key={i} className="group cursor-pointer">
                ...
                <div className="flex gap-2 text-sm text-[#C5A880] mb-2 font-medium">
                  <span>Insights</span> • <span>5 min read</span>
                </div>
                <h4 className="text-xl font-medium text-[#2D2D2D] group-hover:text-[#8E7CC3] transition-colors line-clamp-2">{title}</h4>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section id="contact" className="py-24 bg-[#8E7CC3] text-white scroll-mt-24">
